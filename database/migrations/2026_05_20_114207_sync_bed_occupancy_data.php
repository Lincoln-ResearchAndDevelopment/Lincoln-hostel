...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::transaction(function () {
            ...
            $studentsWithBeds = DB::table('students')
                ->whereNotNull('bed_id')
                ->get();
            
            foreach ($studentsWithBeds as $student) {
                $bed = DB::table('beds')
                    ->where('id', $student->bed_id)
                    ->first();
            ...
            $studentsWithoutBeds = DB::table('students')
                ->whereNotNull('room_id')
                ->whereNull('bed_id')
                ->get();

            foreach ($studentsWithoutBeds as $student) {
                $availableBed = DB::table('beds')
